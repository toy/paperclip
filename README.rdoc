...
In your migrations:
  ...
  class AddAvatarColumnsToUser < ActiveRecord::Migration
    ...
    def self.down
      change_table :users do |t|
        t.remove_paperclip :avatar
      end
    end
  end

`paperclip` method for `create_table` is also supported
There is an option `:no_dimensions => true` if the you don't need dimensions or attachment is not an image at all
